# In this stage the app can get many and different supermarkets, but there is no reset when the button "Ολοκλήρωση Παραγγελίας"
# (because there is no clear logic line, too many flags etc) and also there is no "Edit" button
